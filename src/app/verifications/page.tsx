...
function AllVerificationsContent() {
                ...
                <Card>
                    ...
                    <CardContent className="p-0">
                        {!isReady ? (
                            ...
                            <div className="space-y-3 px-3" style={{ width: '100%' }}>
                                {filteredVerifications.map((result, index) => {
                                    const key = `${result.url}-${result.timestamp}-${index}`;
                                    const isExpanded = expandedItems.has(key);

                                    return (
                                        <div key={key} className="bg-white border rounded-xl shadow-sm overflow-hidden" style={{ width: '100%' }}>
                                            <UltraCompactRow
                                                result={result}
